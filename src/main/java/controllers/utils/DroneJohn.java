public class DroneJohn {
  private Drone drone;

  public DroneJohn(String imuName, String gpsName, String gyroName, String frontLeftLEDName,
  ...
  public static void main(String[] args) {
    ...
    DroneJohn droneJohn = new DroneJohn(inertialUnit, gps, gyro, frontLeftLED, frontRightLED,
